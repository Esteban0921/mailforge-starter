...
| TASK-0020 | UI login/registro + layout autenticado con sidebar                       | Joseph      | En curso  | —          | UI y layout en f2d94dc sobre store mock; TASK-0018 ya listo — falta el swap a cliente HTTP real                   |
