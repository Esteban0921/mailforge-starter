...
| TASK-0022 | Modelos Audience/Subscriber + endpoints CRUD + validación                | Esteban     | En curso | —          | Schema aplicado contra Postgres real (TASK-0016); endpoints esperan organizationId real (TASK-0018/TASK-0019)     |
| TASK-0023 | Importación de suscriptores por CSV                                      | Esteban     | En curso | —          | parseSubscriberCsv (parseo + validación, sin I/O) en packages/shared; endpoint espera TASK-0022                   |
...
ledger conforme se planifiquen, con ids a partir de TASK-0063, siguiendo el protocolo
